...
so in its "Intent and plan section" line, and its own description is the record; where it makes
a delivered spec or plan sentence untrue, it corrects it and records the change in that plan in
